...
public abstract class FileUtils {
    ...
    static {
        ...
        FILE_TYPE_MAP.put("31323300000000000000", "txt");
    ...
    public static String getFileType(InputStream inputStream) {
        try {
            ...
            String fileCode = DigestUtils.byte2hex(bytes).toLowerCase();
